...
shared.CGuiLibrary = {
    ...
    template_buton.TextColor3 = Color3.new(250,250,250)
    template_buton.TextScaled = true
    template_buton.TextSize = 14
    template_buton.TextWrapped = true
    template_buton.BackgroundColor3 = Color3.new(0,0,0)
...
warn:Destroy()
	...
	template_value.TextColor3 = Color3.new(250,250,250)
	template_value.TextScaled = true
	template_value.TextSize = 14
	template_value.BackgroundColor3 = Color3.new(0,0,0)
